...
每当你在处理 Remotion 代码以获取特定领域的专业知识时，请使用此技能。

## 如何使用

阅读各个规则文件以获取详细说明和代码示例：

- [rules/3d.md](rules/3d.md) - 在 Remotion 中使用 Three.js 和 React Three Fiber 处理 3D 内容
...
- [rules/calculate-metadata.md](rules/calculate-metadata.md) - 动态设置合成时长、尺寸和属性 (Props)
- [rules/can-decode.md](rules/can-decode.md) - 使用 Mediabunny 检查浏览器是否可以解码视频
- [rules/charts.md](rules/charts.md) - Remotion 的图表和数据可视化模式
- [rules/compositions.md](rules/compositions.md) - 定义合成 (Composition)、静态图 (Still)、文件夹、默认属性和动态元数据
- [rules/display-captions.md](rules/display-captions.md) - 在 Remotion 中显示字幕，支持 TikTok 样式分页和单词高亮
...
- [rules/measuring-dom-nodes.md](rules/measuring-dom-nodes.md) - 在 Remotion 中测量 DOM 元素的尺寸
- [rules/measuring-text.md](rules/measuring-text.md) - 测量文本尺寸、使文本适应容器并检查溢出
- [rules/sequencing.md](rules/sequencing.md) - Remotion 的编排模式 - 延迟、裁剪、限制项目时长
...
- [rules/timing.md](rules/timing.md) - Remotion 中的插值曲线 - 线性、缓动 (Easing)、弹簧 (Spring) 动画
